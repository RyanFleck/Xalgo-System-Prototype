...
# xalgo_system/
APPS_DIR = ROOT_DIR / "xalgo_system"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "xalgo_system.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "xalgo_system.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Xalgorithms Development Team""", "Ryan.Fleck@protonmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "xalgo_system.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "xalgo_system.users.adapters.SocialAccountAdapter"
