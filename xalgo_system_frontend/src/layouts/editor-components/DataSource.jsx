...
import { Box, FormStandard, Text, Flex, Icon, Button, InfoRow } from '../../components';
    ...
    <div>
      {isOpen ? (
          ...
          <Box padding={3} border="1px solid" borderColor="oline" borderRadius="base">
            ...
            <Box padding={1} />
            <InfoRow color="#F9F8F4" label="Country Jurisdiction" content={country}/>
            <InfoRow color="#FFF" label="Sub-country Jurisdiction" content={subCountry}/>
          </Box>
      )}
    </div>
  );
